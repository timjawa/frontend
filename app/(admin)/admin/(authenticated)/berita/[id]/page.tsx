        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-pulse">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03] space-y-6">
              ...
              <div className="h-64 bg-gray-200 dark:bg-gray-800 rounded-xl w-full" />
              <div className="space-y-2">
                <div className="h-3 bg-gray-200 dark:bg-gray-800 rounded w-1/4" />
                <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-full border-l-4 border-gray-200 pl-4 py-1" />
              </div>
          ...
          <div className="space-y-6">
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03] space-y-4">
              <div className="h-5 bg-gray-200 dark:bg-gray-800 rounded w-1/2 border-b border-gray-100 pb-3" />
              <div className="space-y-3">
