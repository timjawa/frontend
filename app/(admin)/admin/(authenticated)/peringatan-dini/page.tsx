      ...
      <div className="min-h-screen rounded-2xl border border-gray-200 bg-white px-5 py-3 dark:border-gray-800 dark:bg-white/[0.03] xl:px-10 xl:py-8">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl ring-1 ring-slate-100 shadow-sm overflow-hidden">
          ...
          <div className="px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-slate-100">
            <div>
              <h3 className="text-base font-bold text-[#1B2E4B]">Data Peringatan Dini</h3>
              <p className="text-xs text-slate-400 mt-0.5">Kelola peringatan dini bencana untuk masyarakat</p>
            </div>
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="bg-slate-50/80">
                  ...
                  <th className="px-6 py-3.5 text-xs font-semibold uppercase tracking-wider text-slate-400">Deskripsi</th>
                  <th className="px-6 py-3.5 text-xs font-semibold uppercase tracking-wider text-slate-400">Tingkat Urgensi</th>
                  <th className="px-6 py-3.5 text-xs font-semibold uppercase tracking-wider text-slate-400">Berlaku Hingga</th>
                ...
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-slate-400">
                      <HiOutlineBellAlert className="w-10 h-10 mx-auto mb-2 text-slate-300" />
                  ...
                  data.map((row, index) => (
                    <tr key={row.id} className="hover:bg-blue-50/40 transition-colors">
                      ...
                      <td className="px-6 py-4 font-semibold text-[#1B2E4B]">
                        ...
                        <p className="text-xs text-slate-400 font-normal mt-0.5">Dibuat oleh: {row.pembuat?.name ?? "-"}</p>
                      </td>
                      <td className="px-6 py-4">
                        <p className="line-clamp-2 max-w-xs text-sm text-slate-600">{row.deskripsi}</p>
                      </td>
                      <td className="px-6 py-4">
