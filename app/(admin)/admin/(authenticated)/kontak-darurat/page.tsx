      ...
      <div className="min-h-screen rounded-2xl border border-gray-200 bg-white px-5 py-3 dark:border-gray-800 dark:bg-white/[0.03] xl:px-10 xl:py-8">
        <div className="bg-white/80 dark:bg-gray-900/50 backdrop-blur-sm rounded-2xl ring-1 ring-slate-100 dark:ring-gray-800 shadow-sm overflow-hidden">
          ...
          <div className="px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-slate-100 dark:border-gray-800">
            <div>
              <h3 className="text-base font-bold text-[#1B2E4B] dark:text-white">Data Kontak Darurat</h3>
              <p className="text-xs text-slate-400 dark:text-gray-500 mt-0.5">Kelola informasi kontak penting/darurat</p>
            </div>
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="bg-slate-50/80 dark:bg-gray-800/50">
                  ...
                  <th className="px-6 py-3.5 text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-gray-500">Nama Instansi</th>
                  <th className="px-6 py-3.5 text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-gray-500">Nomor Telepon</th>
                ...
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-slate-400 dark:text-gray-500">
                      <HiOutlinePhone className="w-10 h-10 mx-auto mb-2 text-slate-300 dark:text-gray-600" />
                  ...
                  data.map((row, index) => (
                    <tr key={row.id} className="hover:bg-blue-50/40 dark:hover:bg-gray-800/40 transition-colors">
                      ...
                      <td className="px-6 py-4 font-semibold text-[#1B2E4B] dark:text-gray-200">
                        {row.nama}
                        {row.keterangan && <p className="text-xs text-slate-400 dark:text-gray-500 font-normal mt-0.5">{row.keterangan}</p>}
                      </td>
                      <td className="px-6 py-4">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-300 text-sm font-bold font-mono tracking-wider">
                          {row.nomor}
                        </span>
                      </td>
                      <td className="px-6 py-4">
